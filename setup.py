...
DATA_FILES = [
('/usr/share/nautilus-python/extensions',['src/nautilus-pdf-tools.py']),
('/opt/extras.ubuntu.com/nautilus-pdf-tools/share/nautilus-pdf-tools',['debian/changelog']),
('/opt/extras.ubuntu.com/nautilus-pdf-tools/share/icons',['data/icons/updf.svg']),
('/opt/extras.ubuntu.com/nautilus-pdf-tools/share/nautilus-pdf-tools',[
'src/watermarkdialog.py',
'src/textmarkdialog.py',
'src/selectpagesrotatedialog.py',
'src/selectpagesdialog.py',
'src/resizedialog.py',
'src/paginatedialog.py',
'src/nautilus-pdf-tools.py',
'src/miniview.py',
'src/joinpdfsdialog.py',
'src/flipdialog.py',
'src/createpdffromImagesdialog.py',
'src/convertdialog.py',
'src/comun.py',
'src/combinedialog.py'])
]
